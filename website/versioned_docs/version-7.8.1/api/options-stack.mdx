...
An array of buttons to be displayed at the left-side of the TopBar. Button layout is from left to right. See the [Buttons](options-button) section for more details.
